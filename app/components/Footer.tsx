...
export default function Footer() {
  return (
    <footer className="text-white py-12" style={{ backgroundColor: '#4C1D95' }}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-xl font-bold mb-4">Prize Stash</h3>
            <p style={{ color: '#DDD6FE' }}>
              Your AI agent for discovering rewards and savings.
            </p>
            {/* Social Icons */}
            <div className="flex items-center gap-4 mt-4">
              ...
              <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="hover:opacity-80 transition-opacity">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="#DDD6FE">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/signup" style={{ color: '#DDD6FE' }} className="hover:text-white">Talk to Our AI</Link></li>
            </ul>
          </div>
          <div>
            <h4 className="font-semibold mb-4">Legal</h4>
            <ul className="space-y-2">
              <li><Link href="/privacy" style={{ color: '#DDD6FE' }} className="hover:text-white">Privacy Policy</Link></li>
              <li><Link href="/terms" style={{ color: '#DDD6FE' }} className="hover:text-white">Terms of Service</Link></li>
              <li><Link href="/contact" style={{ color: '#DDD6FE' }} className="hover:text-white">Contact Us</Link></li>
            </ul>
          </div>
          <div>
            <h4 className="font-semibold mb-4">Contact</h4>
            <p style={{ color: '#DDD6FE' }}>support@prizestash.com</p>
            <p className="mt-2" style={{ color: '#DDD6FE' }}>8 The Green, Ste A, Dover, DE 19901</p>
            <p className="mt-2" style={{ color: '#DDD6FE' }}>(512) 998-5886</p>
          </div>
        </div>
        <div className="mt-8 pt-8 text-center" style={{ borderTop: '1px solid #7C3AED', color: '#DDD6FE' }}>
          <p>&copy; 2026 Prize Stash. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
